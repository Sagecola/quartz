---
publish: true
created: 2026-01-30T22:58:23.934+08:00
...
> [阅读原文](https://sspai.com/post/86605)
> [在五彩中查看](https://marker.dotalk.cn/#/?nx=H8D93AH&vs=1)


## 划线列表

> [!Annotation]
> <font color="#FFFF83">◇  </font> 就我而言，自 2021 年接触笔记工具以来，我几乎尝试过所有近两年在少数派上被人所介绍过的工具与方法，但是没有一种是我能够按照作者的说明使用下来的。
...
> [!Annotation]
> <font color="#FFFF83">◇  </font> 每个人的精力与热情是有差异的也是有限的，因此，关键在于找到一些办法，在自身行动力执行力的限制下，让自己可以做更多的事情，也即我所说的笔记与自我管理的元方法论。
...
> [!Highlight] 
> <font color="#A6FFE9">◇  </font> 学习方法需要尽可能参照原始资料

> ^b9mbcba

> [!Highlight] 
> <font color="#FFC7BA">◇  </font> 如果对于某个方法感兴趣，学习方法时应当尽可能回到这个概念提出的源头中去，去理解这些概念最主要的提出者是如何使用这些方法的，如此才能高效理解并且根据自己的需要运用。

> ^b93d553

> [!Highlight] 
> <font color="#A6FFE9">◇  </font> 尽可能使用简单熟悉的工具实现核心功能需求

> ^b9mbc2f

> [!Annotation]
> <font color="#FFFF83">◇  </font> 学习工具这件事情本身也是有成本的，并且这件事本身不能带来产出。

> ^b93d5e2
> ---
> 🦊 是的，任何工具的使用都是有时间成本的，我之前也是因为很多笔记软件上手难而选择放弃。

> [!Annotation]
> <font color="#FFC7BA">◇  </font> 利用一些自己熟悉的或者简单的基本工具，根据自己的需要以及想法，实现核心功能。
...
> [!Annotation]
> <font color="#FFFF83">◇  </font> 即便是进阶的需要涉及代码的操作，在 ChatGPT 的时代对于一般人而言也绝非遥不可及。

> ^b9mbc99
> ---
> 🦊 有道理，在gpt蓬勃发展的今天，代码小白可以编写一写简单的脚本实现自己的需求。

> [!Highlight] 
> <font color="#A6FFE9">◇  </font> 抛弃掌控所有信息的幻想，一切以产出为目的

> ^b9mbcf3

> [!Highlight] 
> <font color="#FFC7BA">◇  </font> 承认人的能力限度，放弃控制一切的欲望，专注于眼前的目标。

> ^b9mbcf2

> [!Highlight] 
> <font color="#FFC7BA">◇  </font> 一个人的兴趣是广泛发散的，但是在进行一个项目时，就必须聚焦到特定的范围内，这个范围就是处理信息的主要范围，换言之，如果不是为了产出什么，就没必要花费力气仔细阅读/做笔记。

> ^b9mb9b3

> [!Highlight] 
> <font color="#A6FFE9">◇  </font> 最重要的是对目标的热爱与激情

> ^b93df25

> [!Highlight] 
> <font color="#FFC7BA">◇  </font> 笔记与方法都是锦上添花的东西，真正重要的是内在的对于自己的目标的 incentive 和 passion，这个问题的答案只存在于你的内心，是什么外在方法都给不了你的。

> ^b9mb9be

> [!Annotation]
> <font color="#FFFF83">◇  </font> 其实构建系统有种最基本的思路：数据+流程（现代软件体系也是按数据+程序的结构建立的，理论上这种结构几乎可以应付所有问题）
> 将知识体系和处理知识的过程分成两个模块。
> 一个叫知识库，一个叫工作流。
> 知识库作为我们笔记管理的对象，我们可以对其引用或者存入新笔记。
> 工作流则负责笔记产生过程的全生命周期管理。所有笔记从输入，缓存，完善，组织，输出均在这个模块完成。只有在输出这一步，再确定笔记是存入笔记库，还是交付到项目完成工作。
> 以上就是整个系统的基础模块，如果有其他需求。可以在此基础上加上其他维度的模块。

> ^b9mb9k7
> ---
> 🦊 这是一个很有想法的思路！我可以将遇到的优质内容先存放在Obsidian中，设置独立的主页进行学习并存储。当有相似主题的内容积累到一定程度时，再使用白板或其他工具进行整理，最终形成文章或其他形式的产出。
...
![](https://g1proxy.wimg.site/s7mkSuJNPwio3x4o18L9ucCAM4cmAiszkjtLq7G3z4aM/https://cdn.sspai.com/2024/02/22/a624f1a46dc268e12900d2b0050b4ae7.png?imageView2/2/w/1120/q/40/interlace/1/ignore-error/1)

卢曼卡片笔记的数字化资料库（翻译页面后）

![](https://g1proxy.wimg.site/s2JTrThIEaZo3azcnFrpzIAzh-_k0soFzw-Uz8m-Mtpg/https://cdn.sspai.com/2024/02/23/1c98ab8cc4c240080ab49d19e782c323.png?imageView2/2/w/1120/q/40/interlace/1/ignore-error/1)
...
![](https://g1proxy.wimg.site/s58ulbQPgAVqWMi2XnccMo8w715AN9q_naI0TC8lg8Gk/https://cdn.sspai.com/2024/02/23/62834c7398d195d2597a645d0dc27321.png?imageView2/2/w/1120/q/40/interlace/1/ignore-error/1) 

![](https://g1proxy.wimg.site/sS_yjLuzFaJLSRlHgWPcgKO59UW7Y1QBLFG33I_2iCZY/https://cdn.sspai.com/2024/02/23/643f16aa99e8d2f7a05c473589c89756.png?imageView2/2/w/1120/q/40/interlace/1/ignore-error/1) 

典型的一天时间记录与我 2023 年的工作时间记录表

![](https://g1proxy.wimg.site/sDjr1-nfooNPy3v8b2-kl6QGZjNAS4PT98cbw1tCbyAY/https://cdn.sspai.com/2024/02/23/ac4a1789e94fb9177ff2576e70042243.jpg?imageView2/2/w/1120/q/40/interlace/1/ignore-error/1)
...
![](https://g1proxy.wimg.site/sICSEGKbleSLI50iILWCDnm3JdStdeSPCoeyiBolWYo4/https://cdn.sspai.com/2024/02/23/6a5902ce50512721afa220bf377449a9.png?imageView2/2/w/1120/q/40/interlace/1/ignore-error/1)
...
![](https://g1proxy.wimg.site/sPXQ0cDi-jYOalUfwe0JhNaBotFuwz5SKFZm9L1UKjNI/https://cdn.sspai.com/2024/02/23/9ebdcb42336b11104e169c27fef56e84.png?imageView2/2/w/1120/q/40/interlace/1/ignore-error/1)
