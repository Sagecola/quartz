...
publish: true
title: sage_skills
description: 由 Sagecola 维护的可复用 Claude skill 技能库，统一维护在 skills/ 下，支持多运行时同步。
created: 2026-03-22T16:55:00+08:00
modified: 2026-03-22T17:05:54+08:00
tags:
  - skill
  - claude
  - 工具
...
当前技能清单见 [skills/CATALOG.md](https://github.com/Sagecola/sage_skills/blob/main/skills/CATALOG.md)。

示例：

- [[🌿 专栏/🤖 工具/daily-journal skill]]：将零散生活记录整理为结构化日记，支持写作风格档案与跨日期引用。
- [[🌿 专栏/🤖 工具/chinese-typeset-polish skill]]：按中文与中英混排规范进行排版优化，并做最小化润色。
- [[🌿 专栏/🤖 工具/obsidian-note skill]]：生成带有规范 YAML frontmatter 的 [[Obsidian]] 笔记，支持[[影视]]、[[书籍]]、[[人际]]、[[播客]]、[[代码]]、[[报告]]、[[通用]]共 7 种笔记类型。
